...
namespace MacInventoryManagement
{
    public partial class CashierOrder : UserControl
    {
        ...
        public void displayAllAvailableProd()
        {
            ...
            List<AddProduct> dataList = data.allAvailableProducts();
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            if (cb_Category.SelectedIndex == -1 || cb_productID.SelectedIndex == -1 || lbl_prodName.Text == "" || lbl_price.Text == "" || tb_pieces.Value == 0)
            {
                ...
                if (checkConnect())
                {
                    try
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(insertData, connect))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@category", cb_Category.SelectedItem);
        ...
        private void cb_Category_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string selectItem = cb_Category.SelectedItem as string;
            if (selectItem != null)
            {
                if (checkConnect())
                {
                    try
                    {
                        ...
                        string selectData = $"SELECT * FROM products WHERE category = '{selectItem}' AND status = @status";
        ...
        private void dg_product_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cb_Category.SelectedItem = row.Cells[3].Value;
